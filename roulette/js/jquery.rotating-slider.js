    ...
    $.fn.rotatingSlider = function (options) {
        var rotatingSlider = {
            init: function (el) {
                ...
                this.currentRotationAngle = 0;//初期の回転数
            ...
            handleDragMove: function (e) {
                if (this.readyToDrag) {
                    ...
                    if (this.currentlyDragging) {
                        ...
                        this.$slidesContainer.css('transform', 'translateX(-50%) rotate(' + 90 + 'deg) scale(1.5)');
                    }
                }
            },
            ...
            renderSlider: function () {
                ...
                this.$slidesContainer.css('transform', 'translateX(-50%) scale(1.5)');
                ...
                this.$slides.each(function (i, el) {
                    ...
                    $slide.css('transform', 'translateX(-50%) rotate(' + this.slideAngle * i + 'deg) translateY(-' + upperArcHeight + 'px) scale(1.0)');
                ...
                if (this.settings.directionControls) {
                    ...
                    directionArrowsHTML += '<li class="left-arrow"><button></button></li>';
                    directionArrowsHTML += '<li class="right-arrow"><button></button></li>';
            ...
            rotate: function () {
                ...
                this.$slidesContainer.css('transform', 'translateX(-50%) rotate(' + this.currentRotationAngle + 'deg)  scale(1.5)');
